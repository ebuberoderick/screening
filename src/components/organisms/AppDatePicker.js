...
function AppDatePicker({label}) {
    return (
        <div className='text-[16px] relative rounded-lg'>
            <input type='date' id={label} className='w-full appearance-none border focus:border-[#025C56] border-[#025C56] placeholder-shown:border-gray-300 p-3 peer outline-none rounded-lg placeholder:text-transparent' placeholder={label} />
            <span className='text-xl absolute top-3 right-3 bg-white pointer-events-none text-[#025C56] peer-focus:text-[#025C56] peer-placeholder-shown:text-gray-300'><i className="ri-arrow-down-s-line"></i></span>
