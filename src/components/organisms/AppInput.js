...
function AppInput({label}) {
  return (
    <div className='text-[16px] relative rounded-lg'>
        <input className='w-full border focus:border-[#025C56] border-[#025C56] placeholder-shown:border-gray-300 p-3 peer outline-none rounded-lg placeholder:text-transparent' placeholder={label} />
